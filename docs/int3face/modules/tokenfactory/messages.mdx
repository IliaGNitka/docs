...
### CreateDenom[​](#createdenom "Direct link to CreateDenom")
...
* Fund [Neutron DAO Treasury](/docs/neutron/dao/overview) with the denom creation fee from the creator address, specified in `Params`;
...
### ForceTransfer[​](#forcetransfer "Direct link to ForceTransfer")
...
### ChangeAdmin[​](#changeadmin "Direct link to ChangeAdmin")
...
### SetDenomMetadata[​](#setdenommetadata "Direct link to SetDenomMetadata")
...
### SetBeforeSendHook[​](#setbeforesendhook "Direct link to SetBeforeSendHook")
...
Updates [params](/docs/neutron/modules/3rdparty/osmosis/tokenfactory/params) of the module.
...
* Check that sender of the message is the `Authority` of the module. Currently it's an address of Neutron's [AdminModule](/docs/neutron/modules/admin-module/overview)
